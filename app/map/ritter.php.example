    ...
    <div class="row">
        <div class="col-12">
            <h1 class="h4 mb-3">
                ...
                <?php if ($editMode): ?>
                    <span class="badge bg-warning">MODALITÀ MODIFICA</span>
                <?php endif; ?>
            </h1>
            ...
            <div class="row mb-3">
                <div class="col-md-8">
                    <?php if (!$editMode): ?>
                        ...
                        <a href="?edit=1" class="btn btn-warning btn-sm ms-3">🖊️ Modalità Modifica</a>
                    <?php else: ?>
                        <a href="/app/map/ritter.php" class="btn btn-primary btn-sm">← Esci da modalità modifica</a>
                    <?php endif; ?>
                    <a href="/app/map/bola.php" class="btn btn-outline-primary btn-sm ms-2">Mappa Porto Bola</a>
                </div>
...
function saveEdit() {
    ...
    // Calcola i bounds per compatibilità
...
function updateRotation(value) {
    ...
    if (currentRectangle && currentRotation !== 0) {
        ...
        // Torna al rettangolo se rotazione è 0
...
function saveRectangle() {
    ...
    if (currentPolygon && currentRotation !== 0) {
        ...
        // Calcola bounds per compatibilità
        var bounds = new google.maps.LatLngBounds();
...
<script async defer 
    src="https://maps.googleapis.com/maps/api/js?key=<?php echo htmlspecialchars($google_maps_key); ?>&libraries=drawing&callback=initMap">
</script>
