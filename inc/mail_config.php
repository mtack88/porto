...
define('SMTP_USERNAME', 'maurotacchella@gmail.com'); // Username SMTP
define('SMTP_PASSWORD', 'esjsfflgelqjjgyf');        // Password SMTP
define('SMTP_FROM_EMAIL', 'maurotacchella@gmail.com'); // Email mittente
